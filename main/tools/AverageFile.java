...
public class AverageFile {
    ...
    static String avg_coverage_location = Settings.result_location + Settings.average_coverage;
    static String[] index;
    ...
    public static void create_avg_files() {
        for(String method : Settings.get_methods()) {
            for(String file_to_copy : Settings.jacoco_report_files_for_copy_in_avg_result()) {
                Terminal.copy(Settings.report_location + "0/" + method + Settings.coverage + file_to_copy,
                        avg_coverage_location + method);
            }
    ...
    private static void set_indexes_content(String method, String file_loc_in_coverage){
        String file_loc_in_report_i = "/" + method + Settings.coverage + file_loc_in_coverage;

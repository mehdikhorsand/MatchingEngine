...
public class Terminal {
    ...
    public static void run_jacoco(String mode) {
        ...
        run_command("/usr/lib/jvm/java-11-openjdk/bin/java " +
                ...
                "-javaagent:/usr/share/idea/lib/idea_rt.jar=43219:/usr/share/idea/bin -Dfile.encoding=UTF-8 " +
                "-classpath /usr/share/idea/plugins/maven/lib/maven3/boot/plexus-classworlds-2.7.0.jar:" +
                "/usr/share/idea/plugins/maven/lib/maven3/boot/plexus-classworlds.license " +
                "org.codehaus.classworlds.Launcher -Didea.version=2023.2.4 " + mode);
    }

    public static void run_pitest() {
        System.out.println(ConsoleColors.BLUE_BOLD + "Running PiTest." + ConsoleColors.RESET);
        run_command("/usr/lib/jvm/java-11-openjdk/bin/java " +
                "-javaagent:/usr/share/idea/lib/idea_rt.jar=44945:/usr/share/idea/bin -Dfile.encoding=UTF-8 " +
